...
Simülatör güvenli defaultlara çekildi: bilinmeyen yüzey `unknown`, eksik carrier warning, `steps` 8-256 clamp, API response `machineProfileId` ve `isReliable` içerir.
